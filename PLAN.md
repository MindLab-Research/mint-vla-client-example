...
- Process-local ModelActorInventory inventory for actor tracking
...
| Resource orchestration | ModelActorSupervisor, ModelWorkScheduler, and ModelActorInventory coordination |
...
├─────────────────────────────────────────────────────────────────────────┤
│  ModelActorSupervisor / ModelWorkScheduler / ModelActorInventory          │
│  ┌─────────────────────────────────────────────────────────────────┐    │
