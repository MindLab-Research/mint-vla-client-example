...
: "${ISSUE_STARTUP_LEASE:?set ISSUE_STARTUP_LEASE=mint_startup_lease_<n>}"
: "${ISSUE_PORT:?set ISSUE_PORT=10416}"
: "${ISSUE_LOG_FILE:?set ISSUE_LOG_FILE=/tmp/mint_server_issue.log}"
: "${ISSUE_USAGE_LOG_DIR:?set ISSUE_USAGE_LOG_DIR=/tmp/mint_usage_issue}"
...
export MINT_GATEWAY_SESSION_STORE_ACTOR_NAME="mint_gateway_session_store_${ISSUE_NAME_SUFFIX}"
export MINT_SAMPLING_SESSION_STORE_ACTOR_NAME="mint_sampling_session_store_${ISSUE_NAME_SUFFIX}"
export MINT_TRAINING_SESSION_STORE_ACTOR_NAME="mint_training_session_store_${ISSUE_NAME_SUFFIX}"
export MINT_SESSION_HEARTBEAT_ACTOR_NAME="mint_session_heartbeat_store_${ISSUE_NAME_SUFFIX}"
export MINT_SESSION_INDEX_ACTOR_NAME="mint_session_index_store_${ISSUE_NAME_SUFFIX}"
export MINT_MAINTENANCE_CRON_ACTOR_NAME="mint_maintenance_cron_${ISSUE_NAME_SUFFIX}"
export MINT_TRAINING_CLEANUP_EXECUTOR_ACTOR_NAME="mint_training_cleanup_executor_${ISSUE_NAME_SUFFIX}"
export MINT_SAMPLING_CLEANUP_EXECUTOR_ACTOR_NAME="mint_sampling_cleanup_executor_${ISSUE_NAME_SUFFIX}"
...
export MINT_USAGE_LOG_DIR="${ISSUE_USAGE_LOG_DIR}"
...
if [[ "${ISSUE_STARTUP_PRINT_ENV:-0}" == "1" ]]; then
  env | grep -E '^(RAY_ADDRESS|MINT_RAY_CLIENT_ADDRESS|MINT_CODE_ROOT|MINT_RAY_PY_MODULES_CSV|MINT_VLLM_CHILD_PYTHON_EXECUTABLE|MINT_RAY_NAMESPACE|MINT_STARTUP_LEASE_ACTOR_NAME|MINT_MODEL_WORK_SCHEDULER_ACTOR_NAME|MINT_TASK_STATE_STORE_ACTOR_NAME|MINT_GATEWAY_SESSION_STORE_ACTOR_NAME|MINT_SAMPLING_SESSION_STORE_ACTOR_NAME|MINT_TRAINING_SESSION_STORE_ACTOR_NAME|MINT_SESSION_HEARTBEAT_ACTOR_NAME|MINT_SESSION_INDEX_ACTOR_NAME|MINT_MAINTENANCE_CRON_ACTOR_NAME|MINT_TRAINING_CLEANUP_EXECUTOR_ACTOR_NAME|MINT_SAMPLING_CLEANUP_EXECUTOR_ACTOR_NAME|MINT_DISABLE_MINT_ROUTE|MINT_API_KEY|MINT_PORT|MINT_LOG_FILE|MINT_USAGE_LOG_DIR|MINT_MODEL_PLACEMENT_JSON|MINT_DENSE_MODEL_PLACEMENT_JSON|MINT_VLLM_MODEL_PLACEMENT_JSON|MINT_MEGATRON_MODEL_PLACEMENT_JSON)=' | sort
  exit 0
fi
