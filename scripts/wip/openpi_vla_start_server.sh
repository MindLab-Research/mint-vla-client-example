...
FAST_WORKER_INDEX="${MINT_VLA_FAST_WORKER_INDEX:-3}"
PI05_WORKER_INDEX="${MINT_VLA_PI05_WORKER_INDEX:-4}"
...
export MINT_MODEL_PLACEMENT_JSON="{\"openpi/pi0-fast-libero-low-mem-finetune\":{\"replica\":0,\"worker_index\":${FAST_WORKER_INDEX},\"gpu_count\":1},\"openpi/pi05-libero-low-mem-finetune\":{\"replica\":0,\"worker_index\":${PI05_WORKER_INDEX},\"gpu_count\":1}}"
