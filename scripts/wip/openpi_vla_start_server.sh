...
CODE_ROOT="/vePFS-Mindverse/share/code/root/tinker-server-origin-develop-issue472-20260428"
RUNTIME_ROOT="/vePFS-Mindverse/share/code/root/mint-runtime-py31213-origin-develop-vla-20260428r1"
...
FAST_WORKER_IP="${MINT_VLA_FAST_WORKER_IP:-192.168.39.90}"
PI05_WORKER_IP="${MINT_VLA_PI05_WORKER_IP:-192.168.39.91}"
...
export MINT_MODEL_NODE_IPS_JSON="{\"openpi/pi0-fast-libero-low-mem-finetune\":[\"${FAST_WORKER_IP}\"],\"openpi/pi05-libero-low-mem-finetune\":[\"${PI05_WORKER_IP}\"]}"
