"""MoE RL Test: Arithmetic with PPO-style importance_sampling.
...
class TestMoERL:
    def test_arithmetic_rl(self, moe_tokenizer):
        ...
        plot = PlotGenerator().rl_training_curves(session, title="MoE RL (Arithmetic)")
        report = create_test_report(
            test_name="moe_rl_arithmetic",
            test_type="training",
            data=session,
