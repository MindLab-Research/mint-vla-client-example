# Mint-Server OpenAI Compatible SDK Guide

这份文档面向直接使用官方 OpenAI SDK 的用户，说明如何通过 `mint-server` 访问 MinT，并给出已经验证过的调用方式。
...
- [openai_compat_minimal.py](/Users/leixiang/Desktop/mind/mint-server/scripts/tools/openai_compat_minimal.py)
