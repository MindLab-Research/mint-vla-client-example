...
For API semantics (types, loss functions, polling behavior), consult the `tinker-official-reference` skill (`.claude/skills/tinker-official-reference/references/tinker_official_reference.txt`) and keep `tinker_server/models/types.py` aligned.
