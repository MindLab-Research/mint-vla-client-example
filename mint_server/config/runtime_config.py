...
BOOTSTRAP_RUNTIME_ENV_KEYS = frozenset(
    {
        ...
        "MINT_CHECKPOINT_DIR",
        "MINT_PERSISTENT_CHECKPOINT_DIR",
...
SNAPSHOT_CONFIG_ENV_KEYS = frozenset(
    {
        ...
        "MINT_MOE_TRAINING_BACKEND",
        "MINT_QWEN3_30B_TRAINING_BACKEND",
        "MINT_QWEN3_235B_TRAINING_BACKEND",
        ...
        "MINT_SGLANG_ADMIN_SHUTDOWN_TIMEOUT_S",
...
TASK_STATE_ENV_KEYS = frozenset(
    {
        ...
        "MINT_TASK_HOT_KV_STORE_DB_PATH",
