...
def hydrate_from_config_actor(
    ...
    *,
    ...
    This runs before `mint_server.config` loads its module-level settings. It
    intentionally avoids importing `mint_server.config` or `runtime_config` to
