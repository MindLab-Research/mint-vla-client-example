...
from mint_server.backend.openpi.openpi_fast_runtime import OpenPIFastRuntimeSpec, OpenPIFastWorkerClient


OPENPI_FAST_ACTION_WORKER_MODULE = f"{__package__}.openpi_fast_action_worker"
...
class OpenPIFastActionRuntimeSpec(OpenPIFastRuntimeSpec):
    worker_module: str = OPENPI_FAST_ACTION_WORKER_MODULE
