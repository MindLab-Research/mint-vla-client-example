...
class SessionManager:
    ...
    def _restore_from_detached_store(self, session_id: str) -> SessionInfo | None:
        try:
            from mint_server.backend.stores.sampling_session_store import get_sampling_session_info
    ...
    def list_sessions(self) -> list[str]:
        ...
        try:
            from mint_server.backend.stores.sampling_session_store import list_sampling_sessions
