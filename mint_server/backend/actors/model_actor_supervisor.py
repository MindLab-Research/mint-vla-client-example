...
def _is_moe_training_model(model: str) -> bool:
    try:
        from mint_server.backend.core.training_backend_selection import _uses_distributed_training_backend
...
def _selected_moe_training_backend(model: str, backend: str | None = None) -> str:
    ...
    if raw_backend:
        ...
        return raw_backend
    try:
        from mint_server.backend.core.training_backend_selection import _select_moe_training_backend
...
class ModelActorSupervisorCore:
    ...
    async def _ensure_runtime_placement_group(self, spec: ModelActorSpec) -> dict[str, Any] | None:
        ...
        if controller is None:
            return None
        try:
            from mint_server.backend.scheduling.cluster_placement_controller import placement_group_bundle_request_for_spec
