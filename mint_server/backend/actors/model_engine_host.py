...
async def _default_executor(lease: dict[str, Any]) -> ExecutorOutcome:
    ...
    from mint_server.backend.scheduling.model_work_dispatch import execute_model_work_item
...
async def _ensure_execution_bindings(*, force_refresh: bool = False) -> ExecutionContext:
    ...
    from mint_server.backend.ops.execution_bindings import initialize_execution_bindings
