...
from tinker_server.backend import megatron_distributed as mg
...
def test_issue_353_engine_optim_step_uses_training_remote_call_timeout(monkeypatch):
    ...
    monkeypatch.setattr("tinker_server.backend.verl_training.server_config.training_remote_call_timeout_s", 123.0)
