...
def test_issue_248_internal_metrics_exposes_phase1_and_phase2_fields(monkeypatch) -> None:
    ...
    expected_lines = (
        ...
        'tinker_work_queue_scheduler_domain_capacity_workers{backend="vllm",execution_scope="local",scheduler_domain="vllm:Qwen/Qwen3-4B-Instruct-2507::replica::0"} 2',
        'tinker_work_queue_scheduler_domain_capacity_owner_known{backend="vllm",execution_scope="local",scheduler_domain="vllm:Qwen/Qwen3-4B-Instruct-2507::replica::0"} 1',
        'tinker_work_queue_scheduler_domain_admissible{backend="vllm",execution_scope="local",scheduler_domain="vllm:Qwen/Qwen3-4B-Instruct-2507::replica::0"} 1',
        ...
        'tinker_megatron_session_switch_total{base_model="Qwen/Qwen3-30B-A3B-Instruct-2507",session_state="existing"} 3',
        'tinker_megatron_session_switch_duration_s_total{base_model="Qwen/Qwen3-30B-A3B-Instruct-2507",phase="total",session_state="existing"} 28.5',
        'tinker_vllm_workload_requests_total{base_model="Qwen/Qwen3-4B-Instruct-2507",op="asample",status="ok"} 8',
        'tinker_vllm_workload_prompt_tokens_total{base_model="Qwen/Qwen3-4B-Instruct-2507",op="asample",status="ok"} 4096',
        'tinker_vllm_workload_generated_tokens_total{base_model="Qwen/Qwen3-4B-Instruct-2507",op="asample",status="ok"} 512',
        'tinker_vllm_workload_active_requests{base_model="Qwen/Qwen3-4B-Instruct-2507",op="asample"} 2',
