...
async def _fake_admission_stats(*, include_actor_rss: bool = True) -> dict:
    actors = {
        ...
        "model_actor_registry_metadata_cache": [
            {
                "actor_type": "megatron",
                "cache_hits_total": 9,
                "cache_stale_total": 3,
    ...
    if include_actor_rss:
        ...
        actors["model_actor_registry"][0].pop("rss_bytes", None)
        actors["model_actor_registry"][0]["rss_cache_state"] = "unknown"
    return {
...
async def _fake_admission_stats_with_cached_rss(*, include_actor_rss: bool = True) -> dict:
    ...
    rec = stats["actors"]["model_actor_registry"][0]
    rec["rss_bytes"] = 4096
...
def test_issue_248_internal_metrics_omits_unknown_model_actor_registry_rss(monkeypatch) -> None:
    ...
    expected_lines = (
        ...
        'mint_model_actor_registry_actor_idle_time_s{actor_name="vllm-1",actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507"} 2',
        'mint_model_actor_registry_actor_age_s{actor_name="vllm-1",actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507"} 50',
        'mint_model_actor_registry_actors{actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507"} 1',
        'mint_model_actor_registry_actor_rss_cache_state{actor_name="vllm-1",actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507",state="unknown"} 1',
        'mint_model_actor_registry_group_rss_cache_samples{actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507",state="unknown"} 1',
    ...
    extra_lines = (
        ...
        'mint_model_actor_registry_actor_gpu_binding{actor_name="vllm-1",gpu_index="0",hostname="host-a",workload="sample"} 1',
        ...
        'mint_model_actor_registry_actor_gpu_binding{actor_name="megatron-1",gpu_index="0",gpu_uuid="GPU-host-b-0",hostname="host-b",workload="train"} 1',
        'mint_model_actor_registry_actor_gpu_binding{actor_name="megatron-1",gpu_index="1",gpu_uuid="GPU-host-b-1",hostname="host-b",workload="train"} 1',
        'mint_model_actor_registry_observability_cache_hits_total{actor_type="megatron"} 9',
        'mint_model_actor_registry_observability_cache_stale_total{actor_type="megatron"} 3',
        'mint_model_actor_registry_observability_refresh_success_total{actor_type="megatron"} 2',
        'mint_model_actor_registry_observability_refresh_failures_total{actor_type="megatron"} 1',
        'mint_model_actor_registry_observability_cache_hits_total{actor_type="vllm"} 12',
        'mint_model_actor_registry_observability_refresh_success_total{actor_type="vllm"} 3',
    ...
    assert 'mint_model_actor_registry_actor_rss_bytes{actor_name="vllm-1"' not in text
    assert 'mint_model_actor_registry_group_rss_bytes{actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507"}' not in text
...
def test_issue_248_internal_metrics_emits_group_rss_when_cached_sample_exists(monkeypatch) -> None:
    ...
    assert (
        'mint_model_actor_registry_group_rss_bytes{actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507"} 4096'
        in text
    )
    assert (
        'mint_model_actor_registry_actor_rss_bytes{actor_name="vllm-1",actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507"} 4096'
        in text
    )
    assert (
        'mint_model_actor_registry_actor_rss_cache_state{actor_name="vllm-1",actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507",state="fresh"} 1'
        in text
    )
    assert (
        'mint_model_actor_registry_group_rss_cache_samples{actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507",state="fresh"} 1'
        in text
    )
...
def test_issue_248_internal_metrics_marks_stale_cached_rss_without_emitting_value(monkeypatch) -> None:
    ...
    assert (
        'mint_model_actor_registry_actor_rss_cache_state{actor_name="vllm-1",actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507",state="stale"} 1'
        in text
    )
    assert (
        'mint_model_actor_registry_group_rss_cache_samples{actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507",state="stale"} 1'
        in text
    )
    assert (
        'mint_model_actor_registry_actor_rss_sample_age_s{actor_name="vllm-1",actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507"} 120'
        in text
    )
    assert 'mint_model_actor_registry_actor_rss_bytes{actor_name="vllm-1"' not in text
    assert 'mint_model_actor_registry_group_rss_bytes{actor_type="vllm",model="Qwen/Qwen3-4B-Instruct-2507"}' not in text
...
def test_issue_588_admission_stats_rss_path_preserves_model_actor_registry_metadata(monkeypatch) -> None:
    ...
    model_actor_registry_module = importlib.import_module("tinker_server.backend.model_actor_registry")
    ...
    monkeypatch.setattr(model_actor_registry_module, "get_model_actor_registry", lambda: _FakePool())
...
def test_issue_248_admission_stats_metrics_path_uses_cached_pool_snapshot(monkeypatch) -> None:
    ...
    assert isinstance(stats.get("actors", {}).get("model_actor_registry"), list)
