...
def test_save_weights_for_sampler_route_is_defined_once():
    ...
    weights_txt = (repo_root / "mint_server/routes/weights.py").read_text(encoding="utf-8")
    training_txt = (repo_root / "mint_server/routes/training.py").read_text(encoding="utf-8")
