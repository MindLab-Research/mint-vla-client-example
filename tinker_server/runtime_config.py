...
ACTOR_CREATION_INPUT_KEYS = frozenset(
    {
        ...
        "MINT_MODEL_ACTOR_REGISTRY_ACTOR_NAME",
...
SNAPSHOT_CONFIG_ENV_KEYS = frozenset(
    {
        ...
        "MINT_MODEL_ACTOR_REGISTRY_RSS_TTL_S",
        "MINT_MODEL_ACTOR_REGISTRY_OBSERVABILITY_TTL_S",
        "MINT_MODEL_ACTOR_REGISTRY_OBSERVABILITY_TIMEOUT_S",
        "MINT_MODEL_ACTOR_REGISTRY_OBSERVABILITY_REFRESH_CONCURRENCY",
