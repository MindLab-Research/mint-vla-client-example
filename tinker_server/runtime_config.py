...
SNAPSHOT_CONFIG_ENV_KEYS = frozenset(
    {
        ...
        "MINT_MODEL_ACTOR_SUPERVISOR_INVENTORY_RSS_TTL_S",
        "MINT_MODEL_ACTOR_SUPERVISOR_INVENTORY_OBSERVABILITY_TTL_S",
        "MINT_MODEL_ACTOR_SUPERVISOR_INVENTORY_OBSERVABILITY_TIMEOUT_S",
        "MINT_MODEL_ACTOR_SUPERVISOR_INVENTORY_OBSERVABILITY_REFRESH_CONCURRENCY",
